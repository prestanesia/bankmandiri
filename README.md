Bank Mandiri
--------
Modul pembayaran Bank Mandiri untuk PrestaShop 1.6.x (branch: 1.6) dan PrestaShop 1.7.x (branch: master)
...
* Rename bankmandiri-master.zip menjadi bankmandiri.zip
